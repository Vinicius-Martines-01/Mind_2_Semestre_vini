...
// put
router.put('/psicologo/', async (req, res) => {
...
// lista os pacientes
router.get('/psicologo/', async (req, res) => {
  try {
...
// busca pelo nome
router.get('/psicologo/nome/:nome', async (req, res) => {
...
router.put('/psicologo/atualizar/:id', async (req, res) => {
  const { id } = req.params;
...
// Deletar por ID
router.delete('/psicologo/deletar/:id', async (req, res) => {
  const { id } = req.params;
